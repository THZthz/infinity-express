...
TEST_CASE("Monadic operations", "[monadic]")
{
	...
	{ // lhs is empty
		...
		STATIC_REQUIRE((std::is_same<decltype(o1r), ie::optional<int>>::value));
		REQUIRE(!o1r);

		// lhs has value
		ie::optional<int> o2 = 40;
		auto o2r = o2.map([](int i) { return i + 2; });
		STATIC_REQUIRE((std::is_same<decltype(o2r), ie::optional<int>>::value));
		...
		auto o7r = o7.map(f7);
		STATIC_REQUIRE((std::is_same<decltype(o7r), ie::optional<ie::monostate>>::value));
	...
	SECTION("and_then")
	{
		...
		STATIC_REQUIRE((std::is_same<decltype(o1r), ie::optional<float>>::value));
		REQUIRE(!o1r);

		// lhs has value
		ie::optional<int> o2 = 12;
		auto o2r = o2.and_then([](int) { return ie::optional<float>{42}; });
		STATIC_REQUIRE((std::is_same<decltype(o2r), ie::optional<float>>::value));
		REQUIRE(o2r.value() == 42.f);

		// lhs is empty, rhs returns empty
		ie::optional<int> o3;
		auto o3r = o3.and_then([](int) { return ie::optional<float>{}; });
		STATIC_REQUIRE((std::is_same<decltype(o3r), ie::optional<float>>::value));
		REQUIRE(!o3r);

		// rhs returns empty
		ie::optional<int> o4 = 12;
		auto o4r = o4.and_then([](int) { return ie::optional<float>{}; });
		STATIC_REQUIRE((std::is_same<decltype(o4r), ie::optional<float>>::value));
		REQUIRE(!o4r);
		...
		STATIC_REQUIRE((std::is_same<decltype(o5r), ie::optional<double>>::value));
		REQUIRE(o5r.value() == 42);

		// ensure that lhs is forwarded
		ie::optional<int> o6 = 42;
		auto o6r = std::move(o6).and_then([](int &&i) { return ie::optional<double>(i); });
		STATIC_REQUIRE((std::is_same<decltype(o6r), ie::optional<double>>::value));
		...
		STATIC_REQUIRE((std::is_same<decltype(o7r), ie::optional<double>>::value));
	...
	SECTION("or else")
	{
		...
		REQUIRE(*(o1.or_else([] { return ie::make_optional(13); })) == 42);

		ie::optional<int> o2;
		REQUIRE(*(o2.or_else([] { return ie::make_optional(13); })) == 13);
	}
