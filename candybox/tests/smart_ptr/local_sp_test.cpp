...
template <class T, class U>
static void
test_nonempty_copy(boost::local_shared_ptr<U> const& p1)
{
...
template <class T, class U>
static void
test_nonempty_move(boost::local_shared_ptr<U>&& p1)
{
	U* q = p1.get();
	long k = p1.local_use_count();
...
template <class T, class U>
void
test_aliasing_(boost::local_shared_ptr<T> const& p1, U* p2)
{
...
template <class T, class U>
static void
test_nonempty_shared_ptr_copy(boost::shared_ptr<U> const& p1)
{
	long k = p1.use_count();
...
template <class T, class U>
static void
test_nonempty_shared_ptr_move(boost::shared_ptr<U>&& p1)
{
	U* q = p1.get();
...
null_shared_ptr_move_test()
{
	...
	test_nonempty_shared_ptr_move<void const volatile>(
	    boost::shared_ptr<T>(static_cast<T*>(0)));
}

template <class T>
static void
new_shared_ptr_move_test()
{
...
template <class T, class U>
static void
test_null_unique_ptr(std::unique_ptr<U>&& p1)
{
	boost::local_shared_ptr<T> p2(std::move(p1));
...
static void
test_nonempty_unique_ptr(std::unique_ptr<U, D>&& p1)
{
	U* q = p1.get();
...
template <class T, class U>
static void
test_nonempty_copy_assign(boost::local_shared_ptr<T> p2, boost::local_shared_ptr<U> const& p1)
{
	long k = p1.local_use_count();
...
null_copy_assign_test()
{
	...
	test_nonempty_copy_assign(
	    boost::local_shared_ptr<T volatile>(static_cast<T volatile*>(0)), p1);
	test_nonempty_copy_assign(
	    boost::local_shared_ptr<T const volatile>(static_cast<T const volatile*>(0)), p1);
...
new_copy_assign_test()
{
	...
	test_nonempty_copy_assign(
	    boost::local_shared_ptr<T const volatile>(new T const volatile()), p1);
...
template <class T, class U>
static void
test_nonempty_move_assign(boost::local_shared_ptr<T> p2, boost::local_shared_ptr<U>&& p1)
{
	U* q = p1.get();
	long k = p1.local_use_count();
...
template <class T>
static void
null_move_assign_test()
{
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T>(), boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const>(), boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T volatile>(), boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const volatile>(),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));

	test_nonempty_move_assign(
	    boost::local_shared_ptr<T>(static_cast<T*>(0)),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const>(static_cast<T const*>(0)),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T volatile>(static_cast<T volatile*>(0)),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const volatile>(static_cast<T const volatile*>(0)),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));

	test_nonempty_move_assign(
	    boost::local_shared_ptr<void>(), boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void const>(), boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void volatile>(),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void const volatile>(),
	    boost::local_shared_ptr<T>(static_cast<T*>(0)));
}
...
{
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T volatile>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const volatile>(), boost::local_shared_ptr<T>(new T()));

	test_nonempty_move_assign(
	    boost::local_shared_ptr<T>(static_cast<T*>(0)), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const>(static_cast<T const*>(0)),
	    boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T volatile>(static_cast<T volatile*>(0)),
	    boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	...
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T>(new T()), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const>(new T const()), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T volatile>(new T volatile()),
	    boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<T const volatile>(new T const volatile()),
	    boost::local_shared_ptr<T>(new T()));

	test_nonempty_move_assign(
	    boost::local_shared_ptr<void>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void const>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void volatile>(), boost::local_shared_ptr<T>(new T()));
	test_nonempty_move_assign(
	    boost::local_shared_ptr<void const volatile>(), boost::local_shared_ptr<T>(new T()));
}
...
template <class T>
static void
test_nullptr_assign(boost::local_shared_ptr<T> p1)
{
	p1 = nullptr;
...
template <class T>
static void
test_default_reset(boost::local_shared_ptr<T> p1)
{
	p1.reset();
...
template <class T>
static void
empty_shared_ptr_copy_assign_test()
{
...
template <class T>
static void
empty_shared_ptr_copy_assign_test_()
{
	boost::shared_ptr<T> sp1;
...
template <class T, class U>
static void
test_nonempty_shared_ptr_copy_assign(
    boost::local_shared_ptr<T> p2,
    boost::shared_ptr<U> const& p1)
{
	long k = p1.use_count();
...
template <class T>
static void
null_shared_ptr_copy_assign_test()
{
	boost::shared_ptr<T> p1(static_cast<T*>(0));
	...
	test_nonempty_shared_ptr_copy_assign(
	    boost::local_shared_ptr<T const>(static_cast<T const*>(0)), p1);
	test_nonempty_shared_ptr_copy_assign(
	    boost::local_shared_ptr<T volatile>(static_cast<T volatile*>(0)), p1);
	test_nonempty_shared_ptr_copy_assign(
	    boost::local_shared_ptr<T const volatile>(static_cast<T const volatile*>(0)), p1);
...
new_shared_ptr_copy_assign_test()
{
	...
	test_nonempty_shared_ptr_copy_assign(
	    boost::local_shared_ptr<T volatile>(new T volatile()), p1);
	test_nonempty_shared_ptr_copy_assign(
	    boost::local_shared_ptr<T const volatile>(new T const volatile()), p1);
...
template <class T>
static void
empty_shared_ptr_move_assign_test()
{
	boost::local_shared_ptr<T> p2;
...
template <class T>
static void
empty_shared_ptr_move_assign_test_()
{
	boost::local_shared_ptr<T> p2(static_cast<T*>(0));
...
template <class T, class U>
static void
test_nonempty_shared_ptr_move_assign(boost::local_shared_ptr<T> p2, boost::shared_ptr<U>&& p1)
{
	U* q = p1.get();
	long k = p1.use_count();
...
template <class T>
static void
null_shared_ptr_move_assign_test()
{
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T volatile>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const volatile>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	...
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void const>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void volatile>(), boost::shared_ptr<T>(static_cast<T*>(0)));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void const volatile>(),
	    boost::shared_ptr<T>(static_cast<T*>(0)));
}
...
{
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T volatile>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const volatile>(), boost::shared_ptr<T>(new T()));

	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T>(static_cast<T*>(0)), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const>(static_cast<T const*>(0)),
	...
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T>(new T()), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const>(new T const()), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T volatile>(new T volatile()), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<T const volatile>(new T const volatile()),
	    boost::shared_ptr<T>(new T()));

	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void const>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void volatile>(), boost::shared_ptr<T>(new T()));
	test_nonempty_shared_ptr_move_assign(
	    boost::local_shared_ptr<void const volatile>(), boost::shared_ptr<T>(new T()));
}
...
template <class T, class U, class D>
static void
test_nonempty_unique_ptr_assign(boost::local_shared_ptr<T> p2, std::unique_ptr<U, D>&& p1)
{
	U* q = p1.get();
...
new_unique_ptr_assign_test()
{
	...
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const>(), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T volatile>(), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const volatile>(), std::unique_ptr<T>(new T()));

	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T>(static_cast<T*>(0)), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const>(static_cast<T const*>(0)),
	...
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T>(new T()), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const>(new T const()), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T volatile>(new T volatile()), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const volatile>(new T const volatile()),
	    std::unique_ptr<T>(new T()));

	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void>(), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void const>(), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void volatile>(), std::unique_ptr<T>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void const volatile>(), std::unique_ptr<T>(new T()));
}

template <class T>
static void
del_unique_ptr_assign_test()
{
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T>(), std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T volatile>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const volatile>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	...
	test_nonempty_unique_ptr_assign(
	    ...
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T const>(new T const()),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<T volatile>(new T volatile()),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	...
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void const>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
	test_nonempty_unique_ptr_assign(
	    boost::local_shared_ptr<void volatile>(),
	    std::unique_ptr<T, boost::checked_deleter<T>>(new T()));
...
template <class T, class U>
static void
test_pointer_reset(boost::local_shared_ptr<U> p2)
{
	T* q = new T();
...
template <class T, class U>
static void
test_deleter_reset(boost::local_shared_ptr<U> p2)
{
	T* q = new T();
...
template <class T, class U>
static void
test_allocator_reset(boost::local_shared_ptr<U> p2)
{
	T* q = new T();
...
template <class T, class U>
void
test_aliasing_reset_(boost::local_shared_ptr<T> const& p1, U* p2)
{
