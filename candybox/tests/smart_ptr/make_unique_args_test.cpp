...
main()
{
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4, 5);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4, 5, 6);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4, 5, 6, 7);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4, 5, 6, 7, 8);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
	...
	{
		std::unique_ptr<type> result = boost::make_unique<type>(1, 2, 3, 4, 5, 6, 7, 8, 9);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(type::instances == 1);
