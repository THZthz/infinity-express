...
{
	{
		std::unique_ptr<int[][2], boost::alloc_deleter<int[][2], creator<int> > > result =
	...
	{
		std::unique_ptr<int[][2], boost::alloc_deleter<int[2][2], creator<int> > > result =
	...
	}
	{
		std::unique_ptr<const int[][2], boost::alloc_deleter<const int[][2], creator<> > >
		    result = boost::allocate_unique<const int[][2]>(creator<>(), 2, {0, 1});
		BOOST_TEST(result[0][0] == 0);
		BOOST_TEST(result[0][1] == 1);
		BOOST_TEST(result[1][0] == 0);
		BOOST_TEST(result[1][1] == 1);
	}
	{
		std::unique_ptr<const int[][2], boost::alloc_deleter<const int[2][2], creator<> > >
		    result = boost::allocate_unique<const int[2][2]>(creator<>(), {0, 1});
		BOOST_TEST(result[0][0] == 0);
		BOOST_TEST(result[0][1] == 1);
		BOOST_TEST(result[1][0] == 0);
		BOOST_TEST(result[1][1] == 1);
