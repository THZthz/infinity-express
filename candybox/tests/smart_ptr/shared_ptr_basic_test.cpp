...
template <class T>
void
test_is_X(boost::shared_ptr<T> const &p)
{
	BOOST_TEST(p->id() == 1);
	BOOST_TEST((*p).id() == 1);
}
...
template <class T>
void
test_is_X(boost::weak_ptr<T> const &p)
{
	BOOST_TEST(p.get() != 0);
...
template <class T>
void
test_is_Y(boost::shared_ptr<T> const &p)
{
	BOOST_TEST(p->id() == 2);
	BOOST_TEST((*p).id() == 2);
}
...
template <class T>
void
test_is_Y(boost::weak_ptr<T> const &p)
{
...
void
test_shared(boost::weak_ptr<T> const &a, boost::weak_ptr<U> const &b)
{
	BOOST_TEST(!(a < b));
	BOOST_TEST(!(b < a));
}
...
template <class T, class U>
void
test_nonshared(boost::weak_ptr<T> const &a, boost::weak_ptr<U> const &b)
{
	BOOST_TEST(a < b || b < a);
	BOOST_TEST(!(a < b && b < a));
}
...
template <class T>
void
test_is_zero(boost::shared_ptr<T> const &p)
{
	BOOST_TEST(!p);
	BOOST_TEST(p.get() == 0);
}
...
template <class T>
void
test_is_nonzero(boost::shared_ptr<T> const &p)
{
