...
main()
{
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4);
		boost::weak_ptr<X> wp(pi);
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4, 5);
		boost::weak_ptr<X> wp(pi);
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4, 5, 6);
		boost::weak_ptr<X> wp(pi);
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4, 5, 6, 7);
		boost::weak_ptr<X> wp(pi);
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4, 5, 6, 7, 8);
		boost::weak_ptr<X> wp(pi);
	...
	{
		boost::shared_ptr<X> pi =
		    boost::allocate_shared<X>(cxx11_allocator<void>(), 1, 2, 3, 4, 5, 6, 7, 8, 9);
		boost::weak_ptr<X> wp(pi);
