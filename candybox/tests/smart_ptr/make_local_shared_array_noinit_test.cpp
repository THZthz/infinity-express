...
{
	{
		boost::local_shared_ptr<int[]> result = boost::make_local_shared_noinit<int[]>(3);
	...
	{
		boost::local_shared_ptr<int[3]> result = boost::make_local_shared_noinit<int[3]>();
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.local_use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<int>::value));
	...
	{
		boost::local_shared_ptr<type[]> result = boost::make_local_shared_noinit<type[]>(3);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.local_use_count() == 1);
		BOOST_TEST(
	...
	{
		boost::local_shared_ptr<type[3]> result = boost::make_local_shared_noinit<type[3]>();
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.local_use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<type>::value));
