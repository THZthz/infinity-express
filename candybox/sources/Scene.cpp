...
#include "candybox/imgui/backends/imgui_impl_glfw.h"
#include "candybox/imgui/backends/imgui_impl_opengl3.h"
...
//	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE);            // 3.0+ only
	...
	m_framebuffer
	    .reset(new Framebuffer(m_vg, 0, 0, Framebuffer::NO_NVG_IMAGE /* | NVG_SRGB*/));
...
void
candybox::Scene::errorListener(int code, const char *desc)
{
