#ifndef CANDYBOX_BVH_HPP__
#define CANDYBOX_BVH_HPP__
...
public:
	...
	void queryFiltered(Box aabb, uint32_t maskBits, TreeQueryCallback callback, void *context);
