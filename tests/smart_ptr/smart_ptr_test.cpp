...
Incomplete*
get_ptr(boost::shared_ptr<Incomplete>& incomplete)
{
...
Incomplete*
check_incomplete(boost::scoped_ptr<Incomplete>& incomplete)
{
	return incomplete.get();
}

Incomplete*
check_incomplete(boost::shared_ptr<Incomplete>& incomplete, boost::shared_ptr<Incomplete>& i2)
{
	incomplete.swap(i2);
