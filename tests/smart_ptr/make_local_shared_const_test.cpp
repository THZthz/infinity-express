...
main()
{
	...
	{
		boost::local_shared_ptr<X const> pi =
		    boost::make_local_shared<X const>(1, 2, 3, 4, 5, 6);
		boost::weak_ptr<X const> wp(pi);
	...
	{
		boost::local_shared_ptr<X const> pi =
		    boost::make_local_shared<X const>(1, 2, 3, 4, 5, 6, 7);
		boost::weak_ptr<X const> wp(pi);
	...
	{
		boost::local_shared_ptr<X const> pi =
		    boost::make_local_shared<X const>(1, 2, 3, 4, 5, 6, 7, 8);
		boost::weak_ptr<X const> wp(pi);
	...
	{
		boost::local_shared_ptr<X const> pi =
		    boost::make_local_shared<X const>(1, 2, 3, 4, 5, 6, 7, 8, 9);
		boost::weak_ptr<X const> wp(pi);
