...
{
	{
		boost::shared_ptr<int[]> result = boost::allocate_shared<int[]>(creator<int>(), 3);
	...
	{
		boost::shared_ptr<int[3]> result = boost::allocate_shared<int[3]>(creator<int>());
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<int>::value));
	...
	{
		boost::shared_ptr<int[][2]> result = boost::allocate_shared<int[][2]>(creator<>(), 2);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<int>::value));
	...
	{
		boost::shared_ptr<int[2][2]> result = boost::allocate_shared<int[2][2]>(creator<>());
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<int>::value));
	...
	{
		boost::shared_ptr<type[]> result = boost::allocate_shared<type[]>(creator<type>(), 3);
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
	...
	{
		boost::shared_ptr<type[3]> result = boost::allocate_shared<type[3]>(creator<type>());
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<type>::value));
	...
	{
		boost::shared_ptr<type[2][2]> result = boost::allocate_shared<type[2][2]>(creator<>());
		BOOST_TEST(result.get() != 0);
		BOOST_TEST(result.use_count() == 1);
		BOOST_TEST(
		    boost::alignment::is_aligned(result.get(), boost::alignment_of<type>::value));
