...
#ifndef IE_TASK_SCHEDULER_HPP
#define IE_TASK_SCHEDULER_HPP
...
public:
	...
	IE_TS_API void WaitforTask(
	    ...
	    ie::TaskPriority priorityOfLowestToRun_ = TaskPriority(TASK_PRIORITY_NUM - 1));
