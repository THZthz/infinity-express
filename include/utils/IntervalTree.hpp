...
#ifndef IE_INTERVAL_TREE_HPP
#define IE_INTERVAL_TREE_HPP
...
template <typename IntervalType, typename ValueType>
inline std::ostream &
operator<<(std::ostream &out, const ie::Interval<IntervalType, ValueType> &interval)
{
...
template <typename IntervalType, typename ValueType>
inline std::ostream &
operator<<(std::ostream &out, const ie::IntervalTree<IntervalType, ValueType> &tree)
{
	out << "IntervalTree(" << tree.size() << ")";
	return out;
}

#endif // IE_INTERVAL_TREE_HPP
